...
monitor_w = 1280    # width of the display monitor (default 800)(1280 = Kano Screen 10" display)
monitor_h = 800    # height of the display monitor (default 480)(800 = Kano Screen 10" display)
...
camera_iso = 200    # adjust for lighting issues. Normal is 100 or 200. Sort of dark is 400. Dark is 800 max.
                    # available options: 100, 200, 320, 400, 500, 640, 800 (default 500)
